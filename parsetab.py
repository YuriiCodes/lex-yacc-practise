...
_lr_productions = [
  ...
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','yacc_grammar.py',45),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','yacc_grammar.py',46),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','yacc_grammar.py',47),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','yacc_grammar.py',48),
